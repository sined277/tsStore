...
import PizzaCart, { pizzaCartProps } from "../components/PizzaCart"
import { Link } from "react-router-dom"
import { clearCart, selectCartPizzas, selectQuantityOfPizzas, selectTotalPrice } from "../redux/slices/cartSlice"
...
const Cart = () => {
    ...
    const totalQuantity = useSelector(selectQuantityOfPizzas)
    const cartPizzas = useSelector(selectCartPizzas)

    const dispatch = useAppDispatch()
    const pizzasInCart = useSelector(selectCartPizzas)
        ...
        <div className="content">
            <div className="container container--cart">
                <div className="cart">
                    ...
                    {cartPizzas.map((pizzaData: pizzaCartProps) => {
                        console.log(pizzaData)
                        return <PizzaCart {...pizzaData} key={pizzaData.id} />
                    })}
